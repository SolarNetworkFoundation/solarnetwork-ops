# pg_upgrade Guide on FreeBSD (Development)
...
```
NAME               COMPRESS  RATIO   USED  AVAIL  MOUNTPOINT
tsdb-data               lz4  4.16x  36.0G  40.7G  none
tsdb-data/data96        lz4  2.59x   899M  40.7G  /tsdb/data96
tsdb-data/solar96       lz4  4.20x  35.1G  40.7G  /tsdb/solar96
tsdb-idx                lz4  4.15x  29.7G  46.3G  none
tsdb-idx/index96        lz4  4.15x  29.7G  46.3G  /tsdb/index96
wal96                   off  1.00x  5.97G  12.9G  none
wal96/wal96             off  1.00x  5.97G  12.9G  /tsdb/data96/pg_xlog
```

What we need for `tsdb-data` is this:

```
tsdb-data               lz4  4.16x  36.0G  40.7G  none
tsdb-data/data          lz4  2.59x   899M  40.7G  /tsdb/data
```

And then create `/tsdb/data/9.6`  and `/tsdb/data/12` directories.

# Script

See the [pg-upgrade-pg12-dev.sh](../scripts/pg-upgrade-pg12-dev.sh) script.
...
the ".old" suffix from /tsdb/data/9.6/global/pg_control.old.
