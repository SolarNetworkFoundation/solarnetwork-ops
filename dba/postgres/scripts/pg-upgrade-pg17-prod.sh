...
sed -i '' -e 's/url: "\(.*\)"/url: "http:\/\/snf-freebsd-repo.s3-website-us-west-2.amazonaws.com\/solardb_142x64-tsdb5"/' \
...
sed -i '' -e 's/\/sndb\/home\/15/\/sndb\/home\/17/' /etc/rc.conf.min
sed -i '' -e 's/\/sndb\/home\/15/\/sndb\/home\/17/' /etc/rc.conf.full
